...
public class BetterGameMenuScreen extends PauseScreen {
    ...
    private boolean isRemoveGFARB() {
        return BGMConfig.enableRFARB;
    }

    private boolean isModOptions() {
        return BGMConfig.enableModOptions;
    }

    private boolean isShowUpdate() {
        return isModOptions() && BGMConfig.showNotificationModUpdate;
    }

    private boolean isHideUnnecessaryShareToLan() {
        return BGMConfig.enableHideUnnecessaryShareToLan;
    }
